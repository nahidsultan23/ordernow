...
module.exports = function validatefoodItemInput(data,message) {
    ...
    if(!data.category) {
        ...
        error = true;
        message.category = 'Category can not have more than 50 characters';
    }
    ...
    if(!data.subcategory) {
        ...
        error = true;
        message.subcategory = 'Subcategory can not have more than 50 characters';
    }
    ...
    if(!data.name) {
        ...
        error = true;
        message.name = 'Maximum 200 characters are allowed for a name';
    }
    ...
    if(!data.description) {
        ...
        error = true;
        message.description = 'Description length can be between 2 to 5000 characters';
    }
